...
public static class HarmonicMotion {
    ...
    [Serializable]
    public struct HarmonicMotionSettings
    {
        public float dampingRatio;
        public float angularVelocity;
        public float maxVelocity;

        public DampenedSpringMotionParams GetDampenedSpringMotionParams()
        {
            return CalcDampedSpringMotionParams(dampingRatio, angularVelocity);
        }
    }
