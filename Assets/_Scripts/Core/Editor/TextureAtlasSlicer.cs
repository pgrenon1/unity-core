    ...
    private void PerformSlice()
    {
        ...
        if (needsUpdate)
        {
            ...
            try
            {
                ...
                UnityEditor.EditorUtility.DisplayDialog("Success!", "The sprite was sliced successfully.", "OK");
            }
            catch (Exception exception)
            {
                Debug.LogException(exception);
                UnityEditor.EditorUtility.DisplayDialog("Error", "There was an exception while trying to reimport the image." +
        ...
        {
            UnityEditor.EditorUtility.DisplayDialog("Nope!", "The sprite is already sliced according to this XML file.", "OK");
        }
    }
